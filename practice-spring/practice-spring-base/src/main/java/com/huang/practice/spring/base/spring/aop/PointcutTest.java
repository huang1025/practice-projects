...
public class PointcutTest {
    ...
    @Pointcut("execution(* com.huang.practice.spring.base.spring.service.EmployeeService.*(..))")
    ...
    @DeclareParents(value = "com.huang.practice.spring.base.spring.service.EmployeeService", defaultImpl = IntroducerServiceImpl.class)
